...
def test_verify_valid_signature():
    ...
    assert Wallet.verify(wallet.public_key, data, signature) # Check if the verification returns true
...
def test_verify_invalid_signature():
    ...
    assert not Wallet.verify(Wallet().public_key, data, signature) # Check if the verification returns false
