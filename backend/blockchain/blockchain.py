...
class Blockchain:
    ...
    def replace_chain(self, chain):
        """
        Replace the local chain with the incomming one if the following rules apply:
    ...
    def from_json(chain_json):
        """
        Deserialize a list of serilaized blocks into Blockchain instance.
        The resukt will contain a chain list of Block instances.
        """
